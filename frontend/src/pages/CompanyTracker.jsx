          ...
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 text-slate-400">
                Track company-specific preparation, application status, tasks,
                and progress.
              </p>
            </div>
          ...
          <section className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
            ...
            {loading ? (
              ...
              <div className="rounded-xl bg-slate-950 p-10 text-center">
                <Building2 className="mx-auto mb-4 text-blue-300" size={42} />

                <h3 className="text-2xl font-bold">No companies added yet</h3>
                <p className="mt-2 text-slate-400">
                  Add your first target company to track preparation.
                </p>
                ...
                {companies.map((company) => (
                  ...
                  >
                    ...
                    <p className="mt-4 text-sm text-slate-500">
                      Tasks:{" "}
                      {company.tasks?.filter((task) => task.isCompleted)
                        .length || 0}
